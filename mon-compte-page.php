...
<style>
    ...
    form label {
        ...
        /* Aligné à gauche */
        width: 80%;
        /* Limite la largeur des labels à 80% */
        margin-left: 0;
        /* Assure que le label commence à partir du bord gauche */
    }

    form input {
        width: 80%;
        /* Réduit à 80% pour correspondre à la taille des champs de saisie sur la page d'inscription */
        padding: 12px;
        font-size: 16px;
        color: #B7536C;
        ...
        display: block;
        /* Assurer que les champs sont des blocs et s'étendent horizontalement */
        margin-left: auto;
        margin-right: auto;
        /* Centrer les champs */
    }
