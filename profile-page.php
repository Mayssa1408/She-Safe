...
<head>
    ...
    <style>
        ...
        button {
            ...
            color: white;
            border: none;
            padding: 10px 30px; /* Ajuste l'espace autour du texte */
            border-radius: 50px; /* Arrondi complet */
            font-size: 16px;
            font-weight: bold;
            cursor: pointer;
            display: block; /* Rend le bouton centré */
            text-align: center;
...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <textarea id="bio" name="bio" rows="4" placeholder="Parlez un peu de vous..."><?= htmlspecialchars($user['bio']) ?></textarea>
