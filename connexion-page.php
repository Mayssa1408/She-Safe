...
form {
    text-align: left;  /* Garde le texte aligné à gauche dans le formulaire */
}
...
form input {
    ...
    font-size: 16px;
    color: #B7536C;
    background-color: #FFF1F0;  /* Couleur de fond claire pour les champs de saisie */
...
button {
    ...
    padding: 12px 40px;  /* Padding ajusté pour l'air autour du texte */
    border-radius: 50px;  /* Coins arrondis à 50px */
    margin-top: 20px;
    font-size: 18px;
    font-weight: bold;
    cursor: pointer;
    width: auto; /* Permet au bouton de s'adapter à la largeur du texte */
    transition: background-color 0.3s ease, transform 0.2s ease;
    display: block;  /* Le bouton devient un élément de bloc pour pouvoir le centrer */
    margin-left: auto;
    ...
    <div class="container" style="background-color: none; max-width: 1200px; margin-top: 100px; padding: 50px;">
        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                ...
                <p>Pas encore inscrit ? <a href="<?php echo esc_url(home_url('/inscription')); ?>">Créer un compte</a></p>
            </div>
        </div>
    </div>
