...
.faq-intro {
    ...
    padding: 100px 20px 60px; /* Espacement de 100px entre header et premier titre */
    text-align: center;
}
.faq-intro .container {
    display: flex;
...
.faq-intro .text-content h1 {
    font-family: 'Montserrat', sans-serif;
    font-weight: bold;
    font-size: 24px; /* Montserrat Bold 24px */
    color: #B7536C;
}
.faq-intro .text-content p {
    font-family: 'Montserrat', sans-serif;
    font-weight: lighter;
    font-size: 18px; /* Montserrat Light 18px */
    color: #555;
    margin-top: 15px;
}
...
/* Section FAQ */
.faq-section {
    padding: 100px 20px 40px; /* Espacement de 100px entre les sections */
    background-color: #F4C7C2;
}
.faq-section h2 {
    font-family: 'Lora', serif;
    text-align: center;
    font-size: 32px; /* Lora Bold 32px */
    margin-bottom: 30px;
    color: #B7536C;
    font-weight: bold;
}
...
.contact-section h2 {
    ...
    text-align: center;
    margin-bottom: 20px;
    font-size: 32px; /* Montserrat Bold 32px */
    color: #8D8DAF;
}
.contact-section p {
    font-family: 'Montserrat', sans-serif;
    ...
    color: #555;
    font-size: 18px; /* Montserrat Light 18px */
    max-width: 700px; /* Largeur limitée à 700px */
    margin-left: auto;
    margin-right: auto;
}
...
.contact-section .btn-submit {
    ...
    padding: 15px 30px;
    border: none;
    border-radius: 50px; /* Bouton avec arrondis de 50px */
    cursor: pointer;
    font-size: 1rem;
    transition: background 0.3s ease;
    text-align: center;
    ...
    <section class="faq-intro">
        <div class="container">
            <div class="text-content">
                ...
                <p>Consultez notre FAQ pour trouver des réponses rapides ou remplissez le formulaire de contact pour nous faire part de vos besoins. Nous sommes là pour vous accompagner.</p>
            </div>
